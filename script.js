...
const SSLanding = (function(){
  ...
  async function submit() {
    ...
    if (!text) { if (inp) { inp.focus(); inp.style.border='1px solid #F97316'; setTimeout(()=>{inp.style.border='';},1200); } return; }
  ...
  next() {
    ...
    switch(step) {
      ...
      case 5:
        ...
        break;
      case 6:
        // tone already set via radio onchange
        break;
      case 7:
        // goal already set via radio onchange
        break;
      case 8:
      ...
      case 10:
        ...
        // logo already set via _handleLogo
        break;
      case 11:
